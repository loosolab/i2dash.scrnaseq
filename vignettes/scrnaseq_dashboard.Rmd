...
#knitr::include_graphics(path = system.file(package="i2dash.scrnaseq", "../vignettes/images/scatterplot_options.png", mustWork=TRUE))
knitr::include_graphics(path = system.file("images/scatterplot_options.PNG", package="i2dash.scrnaseq", mustWork=TRUE))
```
...
```{r geneExpr, echo=FALSE, out.width='100%', fig.cap="\\label{fig:geneExpr} Example of the feature expression page with linked components."}
