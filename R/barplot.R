...
setMethod("barplot",
          ...
          function(dashboard, y_group_by, x_group_by = NULL, title = NULL, x_group_by_title = NULL, y_group_by_title = NULL, transmitter = NULL) {
            # Create random env i
            ...
            if(is.null(rownames(y_group_by))) rownames(y_group_by) <- 1:nrow(y_group_by)
            ...
            if(!is.null(x_group_by)){
              ...
              if(is.null(rownames(x_group_by))) rownames(x_group_by) <- rownames(y_group_by)
