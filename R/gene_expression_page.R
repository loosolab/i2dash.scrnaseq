...
setMethod("add_gene_expression_page",
          ...
          function(object, sc_object, reduced_dim, metadata, grouping, assay, assay_slot = "data", genes = NULL, title = NULL, menu = NULL, sidebar = NULL) {
            ...
            reduced_dim <- Embeddings(sc_object, reduction = reduced_dim)[,1:2]
            ...
            assay_obj <- GetAssay(object = sc_object, assay = assay)
            ...
            expression <- GetAssayData(object = assay_obj, slot = assay_slot)
